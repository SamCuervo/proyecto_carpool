    ...
    <div class="container"> <a class="navbar-brand text-primary" href="#">
      ...
      <div class="collapse navbar-collapse" id="navbar5">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item text-light"> <a class="nav-link" href="#">Rutas Registradas</a> </li>
        </ul>
      </div>
    </div>
  </nav>
...
busqueda" placeholder="Buscar" required="required">
              <div class="input-group-append"><button type="button" class="btn btn-warning" style=" border-top-right-radius: 4px; border-bottom-right-radius: 4px;">
                  <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;"><a href="vistas/puntsBusc.html" class="text-dark"><i class="fa fa-search" aria-hidden="true"></i></a>
                    </font>
                  </font>
                </button>
                <font style="vertical-align: inherit;">
            ...
            <font style="vertical-align: inherit;">
              <font style="vertical-align: inherit;">
                <font style="vertical-align: inherit;">
                  ...
                  <p class="mb-3 lead text-light">Esto permitira otorgar una direccion de inicio para realizar el registro de ruta, la cual podra visualizar los pasajeros para que asi accedan a sus servicios.</p><button type="button" class="btn btn-warning">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;"><a href="includes/logout.php" class="text-light">Cerrar Sesion</a></font> <!-- font -->
                    </font>
                  </button>
                  <font style="vertical-align: inherit;">
